    ...
    def receive_and_parse_data(self):
        ...
        while True:
            try:
                ...
                # parsed_data = list(map(float, message.split(",")))
...
if __name__ == "__main__":
    ...
    udp_host = "10.157.175.4"  # Receiver's IP address
    udp_port = 5060            # Same port as used by the sender
    file_path = "/home/kifabrik/Documents/segment-anything-2/intersections.txt"  # Path to save the last 10 entries
